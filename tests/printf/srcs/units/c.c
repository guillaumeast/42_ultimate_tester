...
void	test_c(void)
{
	printf(" %s⏱%s Testing %s'%%c' with printable chars%s\n", BLUE, NONE, BLUE, NONE);
	run_test_long("%c", 33);
	run_test_long("%c", 'A');
	run_test_long("%c", 'z');
	run_test_long("%c", 126);

	printf(" %s⏱%s Testing %s'%%c' with non-printable chars%s\n", BLUE, NONE, BLUE, NONE);
	...
	printf(" %s⏱%s Testing %s'%%c' with signed values%s\n", BLUE, NONE, BLUE, NONE);
	run_test_long("%c", -1);
	run_test_long("%c", -42);
	run_test_long("%c", -128); // min for signed char

	printf(" %s⏱%s Testing %s'%%c' with unsigned overflow\n");
	...
	printf(" %s⏱%s Testing %s'%%c' with int limits\n");
